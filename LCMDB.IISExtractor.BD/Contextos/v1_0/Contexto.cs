...
namespace LCMDB.IISExtractor.BD.Contextos.v1_0
{
    public class Contexto : ConexionContextoBD
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AplicacionPool>().HasIndex(p => new { p.IP, p.IdRegistro });
            modelBuilder.Entity<SitioWeb>().HasIndex(p => new { p.IP, p.IdRegistro });
